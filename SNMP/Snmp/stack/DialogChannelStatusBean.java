 ...
 * @version $Revision: 1.14 $ $Date: 2002/10/10 15:13:56 $
 *
 */
        ...
        implements Observer, TreeNode
{
    private static final String     version_id =
        "@(#)$Id: DialogChannelStatusBean.java,v 1.14 2002/10/10 15:13:56 birgit Exp $ Copyright Westhawk Ltd";
...
public TreeNode getChildAt(int childIndex)
{
    ...
    {
        Enumeration enum = channelHash.elements();
