...
public class testprocess extends JComponent 
        implements ActionListener, PropertyChangeListener
{
    ...
    testprocessbean serviceBean = new testprocessbean();
...
//Component initialization
    ...
    private void jbInit() throws Exception
    {
        ...
        actionButton.setText("Show Processes");
...
//Main method
    ...
    {
        testprocess application = new testprocess();
        application.hostname=args;
        application.init();
    ...
    {
       frame.hide();//setVisible(false);// showOneNTService();
    }
