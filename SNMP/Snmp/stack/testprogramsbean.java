...
public class testprogramsbean extends SNMPRunBean implements Observer
{

    public final static String svSvcName = "1.3.6.1.2.1.25.6.3.1.2";
...
public testprogramsbean() 
{
    serviceHash = new Hashtable();
    svSvcName_len = svSvcName.length();
    System.out.println("test process bean");
}

public testprogramsbean(String h, int p) 
{
    this();
    setHost(h);
    setPort(p);
