 ...
 * @version $Revision: 1.9 $ $Date: 2002/10/10 15:13:56 $
 *
 */
public class InterfaceIndexesBean extends SNMPRunBean implements Observer
{
    private static final String     version_id =
        "@(#)$Id: InterfaceIndexesBean.java,v 1.9 2002/10/10 15:13:56 birgit Exp $ Copyright Westhawk Ltd";
...
public void update(Observable obs, Object ov)
{
    ...
    {
        hashKey = String.valueOf(pdu.getIndex());
