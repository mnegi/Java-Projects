...
public class set_one implements Observer
{
    ...
    public int version = SnmpConstants.SNMP_VERSION_2c;
    ...
    public String obname,obid,obvalue,obdesc;
    public boolean isrw,got,tout,getnext;
...
public void sendGetRequest(String host, int port, String community, 
  String oid, int version)
{
    try
    {
...
public int makeconnection(int i)
{
	...
	switch(i)
	{
		...
		case 1: fname="ipgroup.txt"; break;
		case 2: fname="icmpgroup.txt"; break;
		case 3: fname="tcpgroup.txt"; break;
		case 4: fname="udpgroup.txt"; break;
		case 5: fname="snmpgroup.txt"; break;
	}
...
try
{
in=new DataInputStream(new FileInputStream("mibgroups/"+fname));
}
...
//System.out.println("get====="+s);
   ...
   //System.out.println("obid=" + obid);
   //System.out.println("obvalue="+obvalue);
   //System.out.println("obvalue="+obdesc);
  ...
  public int getnextobject()   
  {
   ...
   //System.out.println("obvalue="+obvalue);
     ...
     int ind1=oid.indexOf('.',14);
     //System.out.println("ind1====="+ind1);
     //System.out.println("Index==============================="+oid.substring(0,ind1));
     if(ind1!=-1)
    	  oldid1=oid.substring(0,ind1);
	 else
	     oldid1=oid;
