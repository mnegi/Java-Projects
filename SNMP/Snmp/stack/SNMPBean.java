 ...
 * @version $Revision: 1.8 $ $Date: 2002/11/04 17:56:21 $
 *
 */
public abstract class SNMPBean
{
    private static final String     version_id =
        "@(#)$Id: SNMPBean.java,v 1.8 2002/11/04 17:56:21 birgit Exp $ Copyright Westhawk Ltd";
...
/**
 * Returns the message (if any). The message is used to give the user
 * feedback if anything is happened (usualy when something went wrong)
 * with the connection.
 *
