...
public class testuserbean extends SNMPRunBean implements Observer
{

    public final static String svSvcName = "1.3.6.1.4.1.77.1.2.25";
...
public testuserbean(String h, int p) 
{
    this();
    setHost(h);
    setPort(p);
