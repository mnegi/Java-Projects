...
public class testprocessbean extends SNMPRunBean implements Observer
{

    public final static String svSvcName = "1.3.6.1.2.1.25.4.2.1.2";
...
public testprocessbean(String h, int p) 
{
    this();
    setHost(h);
    setPort(p);
